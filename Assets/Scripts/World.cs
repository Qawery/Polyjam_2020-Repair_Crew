...
namespace Polyjam2020
{
	...
	public class World : MonoBehaviour
	{
		...
		private readonly Dictionary<System.Type, List<(object listener, MethodInfo method)>>
			componentDestroyEventMapping
				= new Dictionary<Type, List<(object, MethodInfo)>>();

		public void RegisterComponentListener(object listener)
		{
			var allMethods = listener.GetType()
		...
		public GameObject InstantiateObject(GameObject originalObject)
		{
		...
		public T InstantiateObject<T>(T original) where T : MonoBehaviour
		{
			return InstantiateObject(original.gameObject).GetComponent<T>();
		}
